...
{
    public partial class GoiYHocPhan : Form
    {
        ...
        public GoiYHocPhan(string nganhHoc, string maNganh)
        {
            InitializeComponent();
        ...
        private void GoiYHocPhan_Load(object sender, EventArgs e)
        {
        ...
        private void btn_lietKe_Click(object sender, EventArgs e)
        {
            ...
            da.Fill(dt);
            dataGridView_KHHT_goiy.DataSource = dt;
            dataGridView_KHHT_goiy.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.AllCells;
            dataGridView_KHHT_goiy.AutoSizeColumnsMode = DataGridViewAutoSizeColumnsMode.Fill;
            conn.Close();
        }
    }
}
